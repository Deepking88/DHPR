...
async def stats_global(client, message: Message, _):
    ...
    await message.reply_photo(
        photo= "https://telegra.ph/file/f0d0487c28bce9887698c.jpg",
...
async def overall_stats(client, CallbackQuery, _):
    ...
    med = InputMediaPhoto(media= "https://telegra.ph/file/f0d0487c28bce9887698c.jpg", caption=text)
    try:
...
async def bot_stats(client, CallbackQuery, _):
    ...
    try:
        ...
        await CallbackQuery.message.reply_photo(
            photo= "https://telegra.ph/file/f0d0487c28bce9887698c.jpg", caption=text, reply_markup=upl
        )
